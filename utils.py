from constants import TOTAL, UNMARRIED, MEDICAL_STATE, HOSPITALIZED, SICK, SIGNS_OBSERVED, ICD_9_DIAGNOSIS, UNKNOWN, VACCINATED_FOR_FLU, VACCINATED_FOR_PNEUMOCOCCUS
